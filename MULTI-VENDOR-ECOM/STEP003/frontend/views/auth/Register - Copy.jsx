            ...
            <div className='bg-[#6f68d1] p-4 rounded-md '>
                ...
                <form>
                    <div  className='flex flex-col w-full gap-1 mb-3 justify-center items-center'>
                        ...
                        <input type="text" id="name" placeholder='Name' required  className='p-2 px-7 py-2 outline-none border border-slate-700 bg-transparent  rounded-md text-white'/>
                    </div>

                    <div  className='flex flex-col w-full gap-1 mb-3 justify-center items-center'>
                        <label htmlFor="email">Email</label>
                        <input type="email" id="email" placeholder='Email' required  className='p-2 px-7 py-2 outline-none border border-slate-700 bg-transparent  rounded-md text-white'/>
                    </div>

                        
                    <div  className='flex flex-col w-full gap-1 mb-3 justify-center items-center'>
                        <label htmlFor="password">Password</label>
                        <input type="password" id="password" placeholder='Password' required  className='p-2 px-7 py-2 outline-none border border-slate-700 bg-transparent  rounded-md text-white'/>
                    </div>
 
                    <div  className='flex w-full gap-3 mb-3 justify-center items-center'>
                       <input type="checkbox" id="remember" className='w-4 h-4 text-blue-600 bg-green-400 rounded border-gray-300 focus:ring-blue-500'/>
